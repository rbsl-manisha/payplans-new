...
<form action="<?php echo $posturl ?>" method="post" name="site<?php echo $this->getName(); ?>Form">
	...
	<div class="row-fluid center">
		...
		<button type="submit" id="payplans-payment-cancel" class="btn " name="payplans_payment_cancel_btn" onClick="offlineChangeAction()"><?php echo XiText::_('COM_PAYPLANS_PAYMENT_CANCEL_BUTTON');?></button>
